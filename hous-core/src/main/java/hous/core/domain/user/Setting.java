...
public class Setting extends AuditingTimeEntity {
    ...
    public void updatePushSetting(Boolean isPushNotification, PushStatus rulesPushStatus, TodoPushStatus newTodoPushStatus, TodoPushStatus todayTodoPushStatus, TodoPushStatus remindTodoPushStatus, PushStatus badgePushStatus) {
