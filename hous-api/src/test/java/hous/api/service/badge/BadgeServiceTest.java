...
public class BadgeServiceTest {
	...
	public void acquire_badge_by_i_am_such_a_person_on_success() {
		...
		// when
		UpdatePersonalityColorResponse updatePersonalityColorResponse = userService.updateUserTestScore(
			updateTestScoreRequestDto, user.getId());
		...
		BadgeCounter badgeCounter = badgeCounterRepository.findByUserIdAndCountType(userId,
	...
	public void acquire_badge_by_our_house_homies_on_success() {
		...
		// when
		UpdatePersonalityColorResponse updatePersonalityColorResponse1 = userService.updateUserTestScore(
			updateTestScoreRequestDto1, user1.getId());
		UpdatePersonalityColorResponse updatePersonalityColorResponse2 = userService.updateUserTestScore(
			updateTestScoreRequestDto2, user2.getId());
	...
	public void acquire_badge_by_i_dont_even_know_me_on_success() {
		...
		assertThat(acquireBadge).isNotNull();
		assertThat(user.getOnboarding().getPersonality().getColor()).isEqualTo(
			updatePersonalityColorResponse.getColor());
