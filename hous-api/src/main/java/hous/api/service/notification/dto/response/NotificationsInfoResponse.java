...
public class NotificationsInfoResponse {
	...
	public static NotificationsInfoResponse of(ScrollPaginationCollection<Notification> notificationsScroll,
		long totalElements) {
		...
		return NotificationsInfoResponse.newScrollHasNext(notificationsScroll.getCurrentScrollItems(), totalElements,
			notificationsScroll.getNextCursor().getId());
	}
	...
	private static NotificationsInfoResponse newScrollHasNext(List<Notification> notificationsScroll,
		long totalElements, long nextCursor) {
		return new NotificationsInfoResponse(getContents(notificationsScroll, DateUtils.todayLocalDateTime()),
			totalElements, nextCursor);
	}
