...
public class UserService {
    ...
    public void updateUserInfo(UpdateUserInfoRequestDto request, Long userId) {
        ...
        onboarding.updateUserInfo(request.getNickname(), request.isPublic(), request.getBirthday(), request.getMbti(), request.getJob(), request.getIntroduction());
    }
    ...
    public void updateUserPushSetting(UpdatePushSettingRequestDto request, Long userId) {
        ...
        setting.updatePushSetting(request.isPushNotification(), request.getRulesPushStatus(), request.getNewTodoPushStatus(), request.getTodayTodoPushStatus(), request.getRemindTodoPushStatus(), request.getBadgePushStatus());
    }
