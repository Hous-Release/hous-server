...
import hous.api.service.notification.NotificationRetrieveService;
...
public class UserRetrieveController {
	...
	public ResponseEntity<SuccessResponse<UserInfoResponse>> getUserInfo(@ApiIgnore @UserId Long userId) {
		return SuccessResponse.success(SuccessCode.GET_MY_PROFILE_INFO_SUCCESS,
			userRetrieveService.getUserInfo(userId));
	}
	...
	public ResponseEntity<SuccessResponse<UserInfoResponse>> getHomieInfo(
		@ApiParam(name = "onboardingId", value = "조회할 호미의 id", required = true, example = "1")
		@PathVariable Long onboardingId, @ApiIgnore @UserId Long userId) {
		return SuccessResponse.success(SuccessCode.GET_HOMIE_PROFILE_INFO_SUCCESS,
			userRetrieveService.getHomieInfo(onboardingId, userId));
	}
	...
	public ResponseEntity<SuccessResponse<PushSettingResponse>> getUserPushSetting(@ApiIgnore @UserId Long userId) {
		return SuccessResponse.success(SuccessCode.GET_USER_PUSH_SETTING_SUCCESS,
			userRetrieveService.getUserPushSetting(userId));
	}
	...
	public ResponseEntity<SuccessResponse<PersonalityInfoResponse>> getPersonalityInfo(
		@ApiParam(name = "color", value = "조회할 성향 색깔", required = true, example = "RED")
		@RequestParam PersonalityColor color) {
		return SuccessResponse.success(SuccessCode.GET_PERSONALITY_INFO_SUCCESS,
			userRetrieveService.getPersonalityInfo(color));
	}
	...
	public ResponseEntity<SuccessResponse<List<PersonalityTestInfoResponse>>> getPersonalityTestInfo() {
		return SuccessResponse.success(SuccessCode.GET_PERSONALITY_TEST_INFO_SUCCESS,
			userRetrieveService.getPersonalityTestInfo());
	}
	...
	public ResponseEntity<SuccessResponse<NotificationsInfoResponse>> getNotificationsInfo(
		@ApiParam(name = "size", value = "스크롤 1회당 조회할 개수", required = true, example = "10")
		...
		return SuccessResponse.success(SuccessCode.GET_NOTIFICATIONS_INFO_SUCCESS,
			notificationRetrieveService.getNotificationsInfo(size, lastNotificationId, userId));
	}
}
